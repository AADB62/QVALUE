...
#p.adjust with scheffe test
#' falta un arroba importFrom DescTools ScheffeTest
#  p.adjust_expanded <- function(data, method, HRVIndices) {
#  if (method == "scheffe") {
#    int_index=data$HRVIndex
#    data_aov=HRVIndices[, int_index]
#    scheffe_results=DescTools::ScheffeTest(data_aov)
#    adjusted_p_vals=scheffe_results$pvalues
#    adjusted_p_vals
#  } else {
